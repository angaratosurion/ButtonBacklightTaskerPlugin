...
package net.pariskoutsioukis.tasker.plugin.buttonvacklightconttroller.ui.activity;
...
public final class EditActivity extends AbstractAppCompatPluginActivity {
    ...
    public void onPostCreateWithPreviousResult(@NonNull final Bundle previousBundle,
        ...
        final  Boolean enableCheckBox = ((CheckBox) findViewById(R.id.cbxEnableKeyboardBacklight)).isChecked();
    }
    ...
    public Bundle getResultBundle() {
        ...
        final  Boolean enableCheckBox = ((CheckBox) findViewById(R.id.cbxEnableKeyboardBacklight)).isChecked();
        result=PluginBundleValues.generateBundle(getApplicationContext(),enableCheckBox);
    ...
    public String getResultBlurb(@NonNull final Bundle bundle) {
        final Boolean message = PluginBundleValues.getBacklightButtonstate(bundle);
